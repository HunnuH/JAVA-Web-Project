  ...
  <%
	...
	if(cookies!=null){
		for(int i=0;i<cookies.length;i++){
			if(cookies[i].getName().equals("shop_email")){
...
.bottomText {
  ...
  <body width="100%" height="100%"; style="background-color:  #999ECB;">
    ...
    <form action="/webproject/menu/shop_login.do" method="post" class="loginForm">
      <h2>SHOP Login</h2>
      <div class="idForm">
        <input type="text" name="shop_email" class="shop_email" placeholder="shop_email" value="<%=email%>">
      </div>
      <div class="passForm">
        <input type="password" name="shop_pass" class="shop_pass" placeholder="shop_pass" >
      </div>
