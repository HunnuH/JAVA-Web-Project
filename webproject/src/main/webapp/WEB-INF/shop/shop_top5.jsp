	...
	<body> 
		...
		<div style="text-align: center; margin-top: 120px;">
			<div style="text-align: ">
				<p><h3 style="font-weight: bold;">우리동네 top5가 알고 싶다면?</h3></p>
			</div>
		
			<div style="text-align: center; " >
				<form action="/webproject/shop/shop_areatop5.do" method="post">
					<input type="hidden" name="category" value=<%=category %>>
					<input type="text"  name="area" placeholder="여기서 검색하세요!   ex)강남구 삼성동" onfocus="this.value=''" style="height: 40px;width: 350px; text-align: center; color : gray">
						...
						<div class="row No1storecard">
							...
							<div style="width:67%; margin-left: 0%">
								...
								<div style="  width:100%; margin-top: 50px; ">
									<div style="text-align: center;">
										<p class="card-text"><h1>대한민국 NO.1 <%=category%> 수선 맛집!</h1></p>
									</div>
